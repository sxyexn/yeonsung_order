...
(2, '젠이츠의 까마귀 발', 14900, '메인', '귀살대를 지키는 까마귀의 날카로운 발톱을 닮은 닭발! 발품을 팔아 확보! 매콤하고 중독적인 맛이 당신을 유혹하며, 숟가락을 멈출 수 없게 만듭니다.', '포카칩피자.png'),
(3, '네즈코의 치유 한 입', 3500, '사이드', '전통을 벗어나 배를 따뜻하게 위로해줄 네즈코의 따뜻한 한 입, 부드럽고 담백한 주먹밥이 당신의 기운을 되돌려줄 것입니다.', '주먹밥.png'),
(4, '아카자의 눈물', 5000, '사이드', '아카자가 인간 하쿠지였을 때 흘린 눈물이 굳어져 만들어진 고소한 치즈피자. 아픈 과거와 함께 짭짤하면서도 깊은 여운을 전합니다.', '포카칩피자.png'),
